...
+ (NSString *)systemUptime {
   ...
   // NSNumber *Days, *Hours, *Minutes;
    ...
    NSDate *date2 = [[NSDate alloc] initWithTimeInterval:UptimeInterval sinceDate:date1];
    ...
    // Format the dates
    NSString *Uptime = [NSString stringWithFormat:@"%ld months %ld days %ld hours %ld minutes",
                        (long)[breakdownInfo month],
                       (long)[breakdownInfo day],
                       (long)[breakdownInfo hour],
                       (long)[breakdownInfo minute]];
